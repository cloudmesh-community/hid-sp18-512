...
\title{Big Data Analytics on the Google Cloud Platform}


\author{Felix Kikaya}
\orcid{1234-5678-9012}
\affiliation{%
  \institution{IIndiana University}
...
\renewcommand{\shortauthors}{F. Kikaya}
...
\keywords{hid-sp18-512, google, cloud, compute}
